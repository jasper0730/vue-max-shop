        ...
        <div class="modal-content">
          <div class="modal-header bg-dark text-white">
            ...
            <button
              ...
              @click="productStore.closeProductModal"
            ></button>
          </div>
            ...
            <div v-if="productStore.selectedProduct?.id" class="row">
              <div class="col-sm-6">
                <img
                  ...
                  :src="productStore.selectedProduct.imageUrl"
              ...
              <div class="col-sm-6">
                ...
                <div
                  v-if="
                    ...
                    productStore.selectedProduct.origin_price === productStore.selectedProduct.price
                  "
                >
                ...
                <div v-else>
                  <del class="h6 text-secondary"
                    >售價：{{ productStore.selectedProduct.origin_price }}</del
                  >
                  <div class="h5 fw-bold text-danger">
                    優惠價：{{ productStore.selectedProduct.price }}
                  </div>
